...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
	<tr>
	  <td colspan="4"><img alt ="" src="../Images/clinical_top3.jpeg" width="1000" height="260"></td>
	</tr>
	<tr>
	  <td width="200" rowspan="2" align="left" valign="top" bgcolor="#d7d7d7"><uc1:UCNavigation id="UserControl2" runat="server"></uc1:UCNavigation></td>
	</tr>
	<tr>
	  ...
	  <td width="770" valign="top" colspan="3">
		...
		<h3 align="center" style="font-family: Arial; font-size: x-large">
			Bienvenido al Sistema <u>clinical</u> </h3>
		  <h4 align="center" style="font-family: Arial" >El &uacute;nico sistema centrado en la interacci&oacute;n entre el paciente y su m&eacute;dico</h4>
		</td>
	</tr>
	<tr>
